...
while True:
    ...
    print('4. Fazer um cópia do dicionário')
    ...
    if opcao == '1':
        # Adiciona um novo par cahver-valor ao dicionário
        chave = input('Digite a chave: ')
        # Validação para garantir que a chave não seja vazia 
        while not chave:
            print('A chav não pode se vazia. Tente novamente.')
            chave = input('Digite a chave: ')
        ...
        print('Cópia dicionário:', copia_dicionario)
